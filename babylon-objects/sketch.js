      let car = {wheels: 7, horsepower: 100, color:'blue'}; //example objecy
      
      let plant = {stems:1,branches:8,leafs:100,color:'green'}; //new object

      console.log(plant.stems);
      console.log(plant.branches);
      console.log(plant.leafs);

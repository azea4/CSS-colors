...
var face = "Front facing surface of an object"; /*Between the quotation marks,
...
var red = "Passion or extreme emotions"; //repeat the instructions with the word "red" (keep in the form of a noun)

var brain = "Container of thoughts"; //repeat the instructions for the word "brain"

var masculine = "Bold"; //define 'masculine' in ADJECCTIVE form, so
//you could sub it into a sentence that uses the word as an ADJECTIVE

var think = "create ideals"; //define 'think' in VERB form,
